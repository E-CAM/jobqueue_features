...
function jobqueue_script {
    docker exec -it slurmctld /bin/bash -c "pip list; OMPI_MCA_rmaps_base_oversubscribe=1 OMPI_ALLOW_RUN_AS_ROOT=1 OMPI_ALLOW_RUN_AS_ROOT_CONFIRM=1 ppytest /jobqueue_features/jobqueue_features --verbose -E slurm -s"
}
