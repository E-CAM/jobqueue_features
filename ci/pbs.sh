...
function jobqueue_after_script {
    ...
    docker exec pbs-master bash -c 'cat /var/spool/pbs/sched_logs/*'
    docker exec pbs-master bash -c 'cat /var/spool/pbs/server_logs/*'
    docker exec pbs-master bash -c 'cat /var/spool/pbs/server_priv/accounting/*'
    docker exec pbs-slave-1 bash -c 'cat /var/spool/pbs/mom_logs/*'
    docker exec pbs-slave-1 bash -c 'cat /var/spool/pbs/spool/*'
    docker exec pbs-slave-1 bash -c 'cat /tmp/*.e*'
    docker exec pbs-slave-1 bash -c 'cat /tmp/*.o*'
    docker exec pbs-slave-2 bash -c 'cat /var/spool/pbs/mom_logs/*'
    docker exec pbs-slave-2 bash -c 'cat /var/spool/pbs/spool/*'
    docker exec pbs-slave-2 bash -c 'cat /tmp/*.e*'
    docker exec pbs-slave-2 bash -c 'cat /tmp/*.o*'
}
